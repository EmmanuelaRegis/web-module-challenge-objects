...
console.log(createMenuItem('chicken', 3, 'Dinner'));
console.log(createMenuItem('ice cream', 2, 'Drinks'));
...
*/
reviews.push({name: 'Emma', rating: 5, feedback: 'i am still learning!'});
...
console.log(addReview(reviews, "Emmanuela Regis", 5, "Great food"));
console.log(addReview(reviews, " Bryan Hague", 5, "Magnificent food"));
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 6: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
